...
//TODO - think about the way to inject Jedium components
public class BasicBehaviour : MonoBehaviour
{
    ...
    void Init()
    {
       //anim = GetComponent<JediumCharacterController>();
       //if (anim != null)
       //{
    ...
    public void SetVH(float v, float h)
    {
        Debug.Log("___CONTROLLER VH");
        this.v = v;
        this.h = h;
