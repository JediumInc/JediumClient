...
public class MoveBehaviour : GenericBehaviour
{
    ...
    void Init()
    {
       // if (behaviourManager.GetAnim != null&&!initialized)
        {
            // Set up the references.
         
            behaviourManager.GetAnimator.SetBool("Grounded", true);
            initialized = true;
	...
	void Update ()
	{
	    ...
	    {
	        // Get jump input.
	        if (!jump && Input.GetButtonDown(jumpButton) && behaviourManager.IsCurrentBehaviour(this.behaviourCode) &&
	...
	{
		// Start a new jump.
		if (jump && !behaviourManager.GetAnimator.GetBool(jumpBool) && behaviourManager.IsGrounded())
		{
	...
	void MovementManagement(float horizontal, float vertical)
	{
		...
		behaviourManager.GetAnimator.SetFloat("Speed", speed, speedDampTime, Time.deltaTime);
	}
